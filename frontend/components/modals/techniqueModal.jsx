...
export default function TechniqueModal({ onClose }) {
  ...
  return (
    <div className="overlay" onClick={onClose}>
            ...
            return (
              ...
              >
                ...
                <div className="info">
                  ...
                  <IoMdInformationCircleOutline className="info-icon" title={"Informações da técnica"} onClick={() => openInfoModal(tec.id)}/>
                </div>
      ...
      {showInfoModal && <InfoModal onClose={closeInfoModal} Type="technique" Id={selectedTechniqueId} />}
    </div>
  );
}