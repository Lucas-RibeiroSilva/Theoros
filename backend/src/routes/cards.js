...
router.put("/:id", authMiddleware, async (req, res) => {
  ...
  try {
    ...
    await prisma.$transaction([
      prisma.cardTrait.deleteMany({ where: { cardId: id } }),
      prisma.cardLimitation.deleteMany({ where: { cardId: id } }),
      prisma.cardExpertise.deleteMany({ where: { cardId: id } }),
      prisma.cardExpansion.deleteMany({ where: { cardId: id } }),
      prisma.cardTechnique.deleteMany({ where: { cardId: id } }),
      prisma.cardMagic.deleteMany({ where: { cardId: id } }),
    ]);
